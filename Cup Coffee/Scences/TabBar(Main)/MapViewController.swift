...
class MapViewController: UIViewController, MKMapViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        let initialLocation = CLLocation(latitude: 30.78579, longitude: 30.80707)
    ...
    private func setStartingLocation(location: CLLocation, distance: CLLocationDistance){
        ...
        let regionBoundary = MKCoordinateRegion(center: location.coordinate, latitudinalMeters: 20000, longitudinalMeters: 20000)
